...
class JobDetail(Resource):
    ...
    @JobOperation.update_job_detail(job_id=int, interface_id=int, job_name=str, job_desc=str, job_index=str,
                                    server_id=int, server_dir=str, server_script=str, return_code=int, old_prep=str,
                                    job_prep=str, user_id=int, old_params=str, job_params=str, is_deleted=int)
    @JobVerify.verify_update_job_id(job_id=int, interface_id=int, job_name=str, job_desc=str, job_index=str,
                                    server_id=int, server_dir=str, server_script=str, return_code=int, old_prep=str,
                                    job_prep=str, user_id=int, old_params=str, job_params=str, is_deleted=int)
    @PermissionVerify.verify_write_permission(job_id=int, interface_id=int, job_name=str, job_desc=str, job_index=str,
                                              server_id=int, server_dir=str, server_script=str, return_code=int,
                                              old_prep=str, job_prep=str, old_params=str, job_params=str,
                                              is_deleted=int)
    def put(job_id):
        """修改任务"""
        payload = get_payload()
...
class JobAdd(Resource):
    ...
    @JobOperation.add_job_detail(job_name=str, interface_id=int, job_desc=str, job_index=str, server_id=int,
                                 server_dir=str, job_prep=str, job_params=str, server_script=str, user_id=int,
                                 return_code=int)
    @JobVerify.verify_add_job_id(job_name=str, interface_id=int, job_desc=str, job_index=str, server_id=int,
                                 server_dir=str, job_prep=str, job_params=str, server_script=str, user_id=int,
                                 return_code=int)
    @PermissionVerify.verify_write_permission(job_name=str, interface_id=int, job_desc=str, job_index=str,
                                              server_id=int, job_prep=str, job_params=str, server_dir=str,
                                              server_script=str, return_code=int)
    def post():
        """新增任务"""
        payload = get_payload()
        params = Response(
...
class JobIndex(Resource):
    @staticmethod
    @JobFilter.filter_job_index(result=list)
    @JobOperation.get_job_index()
    def get():
        """获取所有任务目录"""
        params = Response()
        log.info('获取所有任务目录')
