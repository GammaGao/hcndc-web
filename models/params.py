...
class ParamsModel(object):
    ...
    def get_params_list_all(cursor, condition, page=1, limit=10):
        """获取所有参数列表"""
        command = '''
        SELECT param_id, param_type, param_name, param_value, param_desc, source_name,
        a.is_deleted, p_index_id AS index_id, index_name
    ...
    @staticmethod
    def add_params_detail(cursor, index_id, param_type, param_name, source_id, param_value, param_desc, user_id):
        """新增参数"""
        command = '''
        ...
        VALUES(:index_id, :param_type, :param_name, :source_id, :param_value, :param_desc,
    ...
    def update_params_detail(cursor, index_id, param_id, param_type, param_name, source_id, param_value, param_desc,
        ...
        SET p_index_id = :index_id, param_type = :param_type, param_name = :param_name, source_id = :source_id, param_value = :param_value,
